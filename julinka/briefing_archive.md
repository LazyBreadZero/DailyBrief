# Appetite — Briefing Archive
**Purpose:** Read this file at the start of every briefing run. It logs every story, source, concept, company, and argument covered in previous editions. Use it to: (1) exclude stories already covered in identical form, (2) build continuity references, (3) track which entities and concepts Julinka already knows, (4) identify threads ripe for follow-up.
...
## EDITION 1 — Monday, 1 June 2026

### Lead Story
**Title:** Europe's Venture Market Splits in Two — and Calm/Storm Has Planted Its Flag on the Quieter Side
**Pillar:** Venture Capital
**Core argument:** European venture is growing and shrinking at once — Q1 2026 funding ~€17.6bn (+30% YoY, 2nd straight quarter of gains) but seed deal volume down 44%, early-stage down 30%, with AI taking >50% of the total. Capital is concentrating and getting more selective ("tangible science, real unit economics"). Calm/Storm Ventures (Vienna) closed a €30m second fund on a contrarian preventive-health thesis and is extending into nutrition + climate tech — the door for a food scientist entering venture.
**Key entities introduced:** Calm/Storm Ventures, Lucanus Polagnoli (co-founder, ex-Speedinvest), Michael Ströck (co-founder), Oska Health, Circle Health (2026 portfolio), Concept Ventures (record €/$88m pre-seed, context)
**Key concepts introduced:** "growing-and-shrinking" European funding split; pre-seed reset to $1–3m; flight to "tangible science"; prevention-as-category; nutrition-tech expansion of Calm/Storm's mandate
**Sources used:** Crunchbase News (9/10): https://news.crunchbase.com/venture/funding-picked-up-ai-led-europe-q1-2026/ ; Sifted (9/10): https://sifted.eu/articles/calm-storm-closes-30m-fund ; TechFundingNews (8/10): https://techfundingnews.com/calm-storm-ventures-launches-30m-healthtech-fund/ ; Calm/Storm primary (10/10): https://www.calmstorm.vc/portfolio
**Julinka's Angle delivered:** Claim the nutrition-tech territory at Calm/Storm (one-page sourcing thesis in 30 days); turn food-science background into public edge ("How to read a protein claim"); use Art Basel as low-pretext deal flow + start a regenerative-ag/natural-capital watch-list
**Follow-up threads to watch:** Calm/Storm next 2026 cheques; whether nutrition-tech mandate produces a named deal; European Q2 2026 funding data; Concept Ventures and other fresh pre-seed funds deploying

### Story 2 (Two-column · Food)
**Title:** Meal Replacement Grows Up — 20 Grams of Protein, and a Quiet Pivot to Fermentation
**Pillar:** Food Science
**Core argument:** Meal replacement (~$19bn 2026 → $32bn+ 2034) is mainstreaming as nutrition (Danone/Alpro "Meal to Go", 20g protein). Plant-based repositioning from imitation to nutrition; real capital moving to precision/biomass fermentation ($3.46bn 2026 → $7.16bn 2035). Named: Climax Foods (AI-designed plant proteins), New School Foods (directional-freezing whole-cut). Upcycled ingredients mainstreaming.
**Sources used:** Innova Market Insights (8/10): https://www.innovamarketinsights.com/trends/plant-based-trends-5-top-global-trend-for-2026/ ; npj Science of Food (10/10): https://www.nature.com/articles/s41538-026-00841-4 ; GFI (8/10): https://gfi.org/state-of-the-industry-series/
**Follow-up threads to watch:** Alpro Meal to Go uptake; Climax / New School funding or scale milestones; fermentation cost-curve data

### Story 3 (Two-column · Art)
**Title:** Art Basel Returns to Messe Basel, 18–21 June — and "Conviviality" Is the Word
**Pillar:** Art
**Core argument:** Art Basel flagship 18–21 June (preview 16–17), 290 galleries (21 new), 4,000+ artists. Gold Awardees Nairy Baghramian (Messeplatz) & Ibrahim Mahama (Münsterplatz) take public squares. Ruba Katrib's first Unlimited; Stefanie Hessler's new Parcours; Premiere expands to 17, theme "conviviality." On Julinka's Zurich doorstep.
**Sources used:** Art Basel primary (10/10): https://www.artbasel.com/stories/art-basel-unveils-leading-galleries-and-first-highlights-for-its-2026-flagship-show-in-basel ; Artsy (8/10): https://www.artsy.net/article/artsy-editorial-art-basels-flagship-fair-announces-participating-galleries-new-highlights-2026-edition
**Follow-up threads to watch:** Art Basel sales/attendance read-out post-fair; Unlimited & Parcours reception; Liste discoveries

### Intelligence Briefs
**Brief 1 — K-Wave reaches the table (Food · Culture):** K-food $13.6bn (2025), Seoul targets $16bn exports 2026; Europe = 27.5% of Hallyu coverage; Korean fried chicken #1 (14%) > kimchi (9.5%) > bibimbap (8.2%); SK agrifoodtech funding +171%. Sources: Korea Herald (9/10) https://www.koreaherald.com/article/10428329 ; Statista (8/10); Seoulz (7/10). Follow-up: K-food brands entering DACH retail; ramyeon premiumisation.
**Brief 2 — Nature credits get a rulebook (Nature · Finance):** Biodiversity credits $2bn by 2030 → $69bn by 2050; EU nature-credits expert group (first results 2026); EU biodiversity reporting in force 18 Mar 2026; COP17 CBD Yerevan Oct 2026; $220bn restoring nature vs $7.3tn degrading it; WEF pilot ≥75% to land stewards. Sources: Nature Reviews Biodiversity (10/10) https://www.nature.com/articles/s44358-026-00155-z ; ESG Today (8/10); UNEP FI (9/10). Follow-up: EU certification methodology; first credible nature-credit issuances.
**Brief 3 — Cultivated-meat naming ban (Food · Regulation):** EU moves to bar "meaty" terms for cultivated products; no EU approval yet; Gourmey (FR) first EU novel-food application (cultivated foie gras, Jul 2024, 18mo+). EU more cautious than Singapore/US/Australia. Sources: FoodNavigator (9/10) https://www.foodnavigator.com/Article/2026/04/16/eu-bans-cultivated-meat-terminology/ ; FoodNavigator-USA (9/10). Follow-up: Gourmey EFSA progress; final EU labelling text.
**Brief 4 — Agrifoodtech flight to tangible science (Venture · Agrifoodtech):** Global agrifoodtech $16.2bn 2025 (flat, deals −12%); upstream $9bn (+7%); deeptech 32% of deals (from 22%), 78% seed premium; debt 18.2% (decade high; Chestnut Carbon, Cambrian Innovation). "Era of $3bn grocery-delivery mega-rounds is over." Sources: AgFunderNews (9/10) https://agfundernews.com/agrifoodtech-funding-is-flat-the-interesting-part-is-where-it-isnt ; AgFunder Report 2026 (10/10). Follow-up: 2026 H1 agrifoodtech data; named European deeptech-food rounds.

### Deep Read
**Title:** The Lab Coat in the Boardroom — Why 2026 Made Food Science a Venture Edge
**Core argument:** The market is repricing scientific rigour upward (deeptech 32% of deals, 78% seed premium, debt 18%), while the supply of investors who can read the science hasn't kept up. A food scientist (ETH + 3 yrs Migros) can verify, not just trust, the science — alpha in a flight-to-substance market. Converges with Calm/Storm's preventive-health + nutrition-tech mandate. Macro tailwind: SK +171%, China +43% agrifoodtech funding. Positioning line: "prevention is the category, nutrition is the substrate, rigour is the moat."

### New concepts in Julinka's working vocabulary (do not re-explain)
"Growing-and-shrinking" European funding split; flight to tangible science / 78% deeptech seed premium; prevention-as-category; Calm/Storm preventive-health thesis + nutrition-tech expansion; precision vs biomass fermentation; plant-based "imitation → nutrition"; EU novel-food / cultivated-meat naming constraint; biodiversity/nature credits and the EU nature-credits market; K-food as deliberate state export strategy; agrifoodtech upstream vs downstream split

### Julinka's Angles Issued — Track Completion
- [ ] Write a one-page nutrition-tech sourcing thesis for Calm/Storm — within 30 days
- [ ] Draft a short public essay ("How to read a protein claim") establishing the food-science edge
- [ ] Pick 3 Calm/Storm-adjacent people to meet at Art Basel (16–21 June)
- [ ] Start a European regenerative-ag / natural-capital watch-list (climate mandate on-ramp)
...
## EDITION 8 — Wednesday, 10 June 2026

### Lead Story
**Title:** MATR Foods' €40M Raise Adds a Fourth Architecture — and a Familiar Investor — to Europe's Fermentation Map
**Pillar:** Venture Capital × Food Science
**Core argument:** MATR Foods (Denmark) closed a €40M (~$47M) round — €20M equity co-led by Novo Holdings and Denmark's Export and Investment Fund (EIFO), plus a €20M debt facility from the European Investment Bank — to build a 4,000-tonne/year solid-state fermentation plant in Ansager, Jutland, online 2027, producing fungal-biomass meat-alternative ingredients. This adds Denmark as a sixth country to the Editions 5–7 fermentation map, but on a different axis: Editions 5–7 mapped *feedstock* (what the microbe eats — waste streams, repurposed infrastructure). MATR is a *process-architecture* story — solid-state fermentation (SSF) versus the submerged/precision fermentation used by every company in the prior map — with materially lower capex/opex per the same wave of reporting that covered MATR alongside The EVERY Company's $55M raise. The map now needs two axes, not one.
**Key entities introduced:** MATR Foods; Novo Holdings (as production-side equity investor); EIFO (Export and Investment Fund of Denmark); European Investment Bank (as project debt financier); solid-state fermentation (SSF) as a distinct architecture
**Key concepts introduced:** "Architecture × geography" matrix (process architecture as a second axis alongside feedstock-source geography); SSF vs. submerged/precision fermentation cost structure; blended debt + equity infrastructure financing for fermentation capex; Novo Holdings as a dual-sided allocator (demand-side GLP-1 thesis + production-side equity)
**Sources used:** AgFunderNews (9/10): https://agfundernews.com/armed-with-47m-matr-foods-to-scale-next-generation-of-alt-meat-via-solid-state-fermentation ; FoodIngredientsFirst (9/10): https://www.foodingredientsfirst.com/news/matr-foods-raises-40m.html ; Protein Production Technology (7/10): https://www.proteinproductiontechnology.com/post/matr-foods-raises-eu40-million-to-scale-fermentation-based-meat-alternatives-and-expand-into-europe
**Julinka's Angle delivered:** Write the "architecture × geography" matrix today as the (multiply-overdue) sourcing thesis — a genuinely new structural frame, not a restatement; flag MATR/Novo Holdings as a direct outreach target given Calm/Storm's nutrition mandate and Novo's now-visible dual-sided position
**Follow-up threads to watch:** MATR Foods plant construction progress (Ansager, online 2027); whether a precision-fermentation company in the existing map adopts or contrasts itself against SSF; further Novo Holdings moves across the alt-protein chain; The EVERY Company's Walmart sales data as a retail-scale benchmark

### Story 2
**Title:** Art Basel's Inaugural Gold Awards Put Baghramian and Mahama in Basel's Public Squares — Free, and Eight Days Before VIP Preview
**Pillar:** Art
**Core argument:** Art Basel's new Gold Awards (established-artist category) go to Nairy Baghramian (Messeplatz commission) and Ibrahim Mahama (Münsterplatz commission) — both unveiled as public, free-access works ahead of the June 16–17 VIP preview and June 18–21 fair (290 galleries, 43 countries, 21 first-timers). Mahama's practice — large-scale installations built from jute sacks used in cocoa, grain and charcoal transport across West Africa — sits directly at the intersection of art and agricultural trade infrastructure, the closest thing this fair has to a food-systems artwork, and it is viewable in a public square before the gated VIP week even begins.
**Key entities introduced:** Art Basel Gold Awards (inaugural, established-artist category); Nairy Baghramian (Messeplatz commission); Ibrahim Mahama (Münsterplatz commission)
**Key concepts introduced:** Gold Awards as a new fair-prestige mechanism distinct from Basel Exclusive/Parcours; public-square commissions as a pre-VIP access point
**Sources used:** MCH Group / Art Basel Official (10/10): https://www.mch-group.com/en/media/news/2026/art-basel-unveils-290-galleries-and-first-highlights-for-its-2026-flagship-show-in-basel ; Artsy (8/10): https://www.artsy.net/article/artsy-editorial-art-basels-flagship-fair-announces-participating-galleries-new-highlights-2026-edition
**Follow-up threads to watch:** Mahama's Münsterplatz installation reception and any agricultural-trade commentary; whether Gold Awards becomes an annual fixture; Parcours "Conviviality" artist statements (carried from Edition 7)

### Story 3
**Title:** Brussels' Regions Tell the Commission: Nature Credits Can Help, But They Are Not a Substitute — the Nature-Credits Debate Changes Shape on Workshop Day
**Pillar:** Nature × Policy × Finance
**Core argument:** On the same day as the Biodiversa+/Banque de France nature-positive finance workshop in Paris (the event Editions 3, 6 and 7 have been counting down to), the European Committee of the Regions issued a formal statement: nature credits can help EU regions finance biodiversity projects but cannot replace direct EU financing for environmental action, and should not be used to bridge the €37bn regional financing gap on their own. This is the first visible institutional pushback on the COM(2025)374 "Roadmap towards Nature Credits" since Edition 2 — and it reframes the mid-2026 expert-group deliverable. The open question is no longer just "what methodology" but "what is a nature credit legitimately allowed to be asked to fund, and what must remain public money." That is a governance question, not a measurement one — and it is the sharper version of the farm-level-verification question Edition 7 raised.
**Key entities introduced:** European Committee of the Regions (as an institutional actor in the nature-credits debate)
**Key concepts introduced:** Nature credits as supplement-not-substitute (Committee of the Regions framing); the €37bn regional financing gap (distinct from the €65bn EU-wide figure introduced in Edition 3); governance-of-scope as the live question, displacing pure methodology
**Sources used:** European Committee of the Regions (10/10): https://www.cor.europa.eu/en/news/nature-credits-can-help-eu-regions-finance-biodiversity-projects-not-replace-eu-financing-0 ; Biodiversa+ (10/10): https://www.biodiversa.eu/2026/05/05/workshop-toward-nature-positive-finance-scientific-foundations-for-action/
**Follow-up threads to watch:** Paris workshop outputs (today) and whether they engage the Committee of the Regions framing; expert-group mid-2026 technical-criteria publication; whether the Commission responds to the "supplement not substitute" framing before COP17 (Yerevan, October)

### Intelligence Briefs
- **The EVERY Company's Eggs Reach Walmart — Precision Fermentation's First Mass-Retail Presence in This Beat (Food/Venture):** EVERY Company closed a $55M Series D; its precision-fermented egg proteins are now stocked in Walmart — the first product from any company tracked across Editions 1–8 to reach a major US mass retailer, not just foodservice or specialty channels. Sets a commercial benchmark the Formo-vs-Standing Ovation casein race (Editions 6–7) has not yet reached. Sources: FoodNavigator-USA (9/10): https://www.foodnavigator-usa.com/Article/2025/11/05/the-every-company-closed-55-million-in-series-d-to-make-alt-proteins-accessible-to-everyone/. Follow-up: Walmart sell-through data; whether European retailers follow.
- **Precision-Fermented Dairy Funding Rebounds — Vivici Among Four Companies Raising Again (Food/Venture):** After 2025's 43% drop in fermentation-specific alt-protein funding, precision-fermented dairy is recovering: All G, Those Vegan Cowboys, Vivici (introduced Edition 5, lactoferrin GRAS in Edition 7) and Verley have all secured fresh funding. A category-level signal that the Dutch cluster's regulatory progress (Fermotein, Vivitein LF) is not isolated. Sources: DairyReporter (7/10): https://www.dairyreporter.com/Article/2026/02/27/investment-surges-back-into-precisionfermented-dairy/. Follow-up: round sizes and lead investors for All G, Those Vegan Cowboys, Verley.
- **Seoul Food & Hotel — Day 2 of 4, Directory Still Live (Food/Culture):** 1,600+ exhibitors, 45,000+ visitors expected across the run, 45 countries. The KOTRA buyer-matching exhibitor directory flagged as actionable in Edition 7 remains live through June 12 — the window has not closed, it is open today and tomorrow too. Sources: MICE Travel Advisor (7/10): https://www.micetraveladvisor.com/news/article/seoul-food-hotel-2026-brings-united-states-canada-australia-france-spain-denmark-turkiye-and-forty-five-countries-to-goyang-strengthening-food-tourism-hospitality-growth-business-trave/. Follow-up: whether the directory screen was run; any Korean food-tech shortlist produced.
- **Paris Workshop Convenes Today — First Real-Time Test of the COM(2025)374 Methodology Pipeline (Nature/Finance):** The Biodiversa+/Banque de France workshop (flagged across Editions 3, 6, 7) is happening today, as an EU Green Week 2026 partner event, hours after the Committee of the Regions' "supplement not substitute" statement (Story 3). Central banks, the Commission, IPBES authors and institutional investors are in the room discussing nature-related-risk methodology on the same day a major EU institutional body has just narrowed what nature credits can be asked to do. Sources: Biodiversa+ (10/10): https://www.biodiversa.eu/2026/05/05/workshop-toward-nature-positive-finance-scientific-foundations-for-action/ ; EU Commission/Green Week (10/10): https://environment.ec.europa.eu/news/eu-green-week-2026-opens-focus-nature-investment-2026-06-03_en. Follow-up: workshop synthesis; any reference to the Committee of the Regions framing.

### New concepts in Julinka's working vocabulary
MATR Foods (Denmark, solid-state fermentation, Ansager plant); EIFO (Export and Investment Fund of Denmark); solid-state fermentation (SSF) vs. submerged/precision fermentation; "architecture × geography" matrix (two-axis fermentation-capital map); Novo Holdings as dual-sided allocator (GLP-1 demand thesis + MATR production equity); blended debt+equity infrastructure financing (EIB); Art Basel Gold Awards (Baghramian, Mahama); Ibrahim Mahama's jute-sack/agricultural-trade practice; European Committee of the Regions "supplement not substitute" framing; €37bn regional nature-finance gap (vs. €65bn EU-wide figure, Edition 3); EVERY Company × Walmart as first mass-retail benchmark

### Julinka's Angles Issued — Track Completion
- [ ] Write the "architecture × geography" matrix as the sourcing thesis — submit today; this is a structurally new frame, not a restatement *(supersedes the carried "nutrition-tech sourcing thesis" task, Editions 1–7)*
- [ ] Find a Paris-workshop debrief contact, now armed with a sharper question: not "which methodology" but "what should a nature credit be allowed to fund, given the Committee of the Regions' statement today" *(carried from Edition 3, reframed)*
- [ ] See Mahama's Münsterplatz commission this week (free, public, pre-VIP) — identify the agricultural-trade angle as an Art Basel VIP-week conversation hook *(new)*
- [ ] Use Seoul Food & Hotel KOTRA exhibitor directory — still live through June 12 *(carried from Edition 7, window remains open)*
- [ ] Message Pacifico Biolabs, Standing Ovation, The Bland Company — sourcing outreach *(carried from Editions 5–6)*
- [ ] Write "The Ozempic Diet Needs Better Protein" (300 words) — before Art Basel June 16 *(carried from Edition 4)*
- [ ] Prepare 3 Art Basel VIP conversations, incl. Parcours/Hessler angle *(carried from Edition 3)*
- [ ] Request Planetary technical documentation / BioBlocks publications *(carried from Edition 2)*
...
## EDITION 21 — Wednesday, 24 June 2026

### Lead Story
**Title:** Huvepharma to Quadruple Capacity for Every's Egg Protein After Orders Rose 550% in Four Months
**Pillar:** Food science & Venture
**Core argument:** Huvepharma's Bulgarian subsidiary Biovet AD agreed this month to quadruple manufacturing capacity for The Every Company's OvoPro egg protein after orders grew 550% in four months on the back of Target/Walmart/Amazon listings — financed by Every's existing fermentation partner, not a new funding round (its last raise, a $55m Series D, closed in November). The same pattern repeated twice more in June: Nestlé's multi-year partnership with Helaina (2 June) to build infant formula around effera human-identical lactoferrin, and Solar Foods' Solein reaching US consumers for the first time via Ambrosia Collective (9 June). A FoodNavigator-USA roundup frames this as the fermentation-ingredients category "finding its footing" even as food-tech venture funding broadly cools.
**Key entities introduced:** The Every Company, Arturo Elizondo, Huvepharma/Biovet AD, Anguel Jeliazkov, McWin Capital Partners, Helaina, Laura Katz, Nestlé, Isabelle Bureau-Franz, Solar Foods, Ambrosia Collective
**Key concepts introduced:** Capacity-not-capital — commercial/manufacturing partnerships standing in for new equity rounds as the financing mechanism for precision-fermentation companies that already have a sellable product
**Sources used:** FoodNavigator-USA (8/10): https://www.foodnavigator-usa.com/Article/2026/06/23/every-company-scales-animal-free-egg-protein-as-ovopro-demand-surges-550/ ; Nestlé Newsroom (9/10): https://www.nestle.com/about/research-development/news/helaina-infant-nutrition-science-partnership ; GlobeNewswire (9/10): https://www.globenewswire.com/news-release/2026/06/09/3309024/0/en/Ambrosia-Collective-Launches-Planta-Powered-by-Solein-Bringing-Solar-Foods-Air-Based-Protein-to-U-S-Consumers.html ; FoodNavigator-USA (8/10): https://www.foodnavigator-usa.com/Article/2026/06/23/fermentation-ingredients-attract-investors-cpgs/
**Angle delivered:** Screen the fermentation pipeline for which companies already have a manufacturing partner lined up vs. those still assuming the next round buys that capacity; write a one-pager on early-life nutrition as an underweighted prevention sub-thesis, anchored to Nestlé/Helaina, and find Calm/Storm's own effera before another multinational does
**Follow-up threads to watch:** Whether other precision-fermentation companies announce manufacturing/retail partnerships in lieu of new rounds; whether Nestlé/Helaina names a commercial product timeline; whether Every's Huvepharma capacity expansion has a completion date

### Further items
None — VC and Art pillars were checked and came up genuinely quiet this edition (Art Basel's close is now a week old; no fresh European VC round in her sub-themes surfaced); Believer Meats/UPSIDE auction unchanged (next date July 20).

### New concepts in Julinka's working vocabulary
"Capacity-not-capital" — manufacturing, retail and strategic-partner deals substituting for new venture rounds as the financing mechanism once a fermentation company already has a sellable product (Edition 21)
