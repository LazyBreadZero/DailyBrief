...
- **Does speed-to-regulatory-approval predict speed-to-commercial-revenue, or are the two decoupled?** (new, Ed 22; updated Ed 44) Two 2026 data points now exist in the same calendar year. Neuracle: NMPA commercial approval March 2026 → first insurance-covered patient July 2026, four months, one patient, one centre, zero disclosed revenue programme; the deployment gap may reflect a supply/training constraint or a structural ceiling on qualified patients near certified centres. Science Corp PRIMA: CE mark from DEKRA July 22, 2026 (30 EU countries, geographic atrophy AMD) → first commercial implant "expected soon" in Germany, with EU national HTA reimbursement systems to navigate independently per country — a structurally different pathway from Neuracle's single national insurance route. Two approvals, two reimbursement architectures, two deployment timelines. The essay mapping the structural mechanism that governs the gap is now writable.
...
---
*Last updated: Edition 43 — 22 July 2026*
