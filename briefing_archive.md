...
- **Does speed-to-regulatory-approval predict speed-to-commercial-revenue, or are the two decoupled?** (new, Ed 22; updated Ed 43) Neuracle won the global "first invasive BCI approved for commercial sale" race in March, reported zero implant revenue at its $370m IPO filing in June, and completed its first insurance-covered commercial implant in July — four months from approval to first patient. One patient in one centre is not a revenue curve. The question is now more specific: whether the four-month deployment gap shortens as the programme scales, or reflects a structural ceiling on qualified centres and patients that the $370m capital raise is meant to fund through.
...
- **Samsung's autofocus camera is the most specific, falsifiable hardware differentiator in the audio-glasses category — and Samsung may not be making the argument.** (New, Ed 43.) Meta's Ray-Ban fixed-focus camera cannot reliably read text beyond a few metres; Samsung's 12MP Sony IMX681 with autofocus can, enabling live visual search while the phone stays pocketed. This is a concrete, nameable capability advantage. Samsung's marketing leads with Gemini and "AI companion," not the camera. Whether Samsung makes the autofocus argument in today's keynote is a test of how well the company understands its own best feature; whether the market responds to whoever does make the argument is the category signal for whether audio glasses need a product case or only a platform case.
