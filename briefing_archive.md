...
- **Is "governance" still the right word?** (new, Ed 11, replaces "consent or governance?") Ed 11 showed empirically that "consent" wins disputes because it has a claimant (lawsuits, press, researchers) and "governance" loses because it doesn't — Meta deleted Stella's code (a consent fix) and left every governance question (does NameTag return, what happened to prior data) unanswered, unchallenged. If "governance" commits no one to anything, is it the word Angelo should keep reaching for, or should he name the actual missing thing — a body with standing to review dormant capability pre-launch?
- **Is "jurisdiction is the variable" complete, or only half the picture?** (Ed 10) Yale's neural-manifold result and Merge Labs' AI-layer thesis (Ed 4) imply a second axis — algorithm-to-brain fit — that runs on an academic timeline, not a regulatory one. Ed 11's Neuralink story adds a third dimension again: a platform's addressable indications can now expand by software alone, independent of any single jurisdiction's hardware approval. Has Angelo's map of "what determines BCI's commercial future" kept pace with three axes, or is he still defending a one-axis frame?
- **Is "spatial computing" one market or two?** (new, Ed 11) Snap's $2,500 Specs vs. Android XR's sub-$500 audio glasses is the AR/XR analogue of BCI's hardware-axis/algorithm-axis split (Ed 10): a single industry label may be concealing two markets with different buyers, timelines, and winners. Has Angelo picked which one he's translating for the rooms he's in?
- **What does Angelo believe that AWE's 400 speakers won't say?** (Ed 10) AWE's "I, Spatial" theme is his positioning language, now the industry's. AWE opens in three days — the last natural deadline for this question before the conference's content is locked and, after Friday, retrospective.
- **Is the commercial BCI layer being built by incumbents, startups, or platforms?** (Ed 9-11) Medtronic × Precision Neuroscience and Apple Wheelchair Control (Ed 9), Yale's algorithm-axis result (Ed 10), and Neuralink's software-defined "any brain region" scope (Ed 11) are all data points outside a clean startup-race frame. Has Angelo's "who could plausibly win" map expanded to a genuinely multi-actor picture, or is he still defaulting to the four-company cast from Edition 1?
- **The Science Corp thesis, not the contact:** eleven editions outstanding. Whether Angelo holds a thesis on retinal BCI's commercial path sharp enough to bring to a conversation, now explicitly decoupled from AWE's timeline.
...
- **BCI's commercial structure may now run on three axes, not one or two.** Hardware/regulatory (jurisdiction-driven), algorithmic (academic-timeline, Ed 10), and now software-defined scope (a single platform's addressable indications expanding without new hardware or new jurisdictional approval, Ed 11 Neuralink). "Jurisdiction is the variable" increasingly looks like the most visible of three variables, not the determining one.
- **AR/XR may be bifurcating the way BCI already has.** Snap's $2,500 vs. Android XR's sub-$500 (Ed 11) parallels BCI's hardware-axis/algorithm-axis split (Ed 10): an industry label ("spatial computing," "BCI") covering two markets/races that may not converge, each with different timelines and likely winners.
...
- Reaching for the **softer or more familiar word** (consent vs governance; jurisdiction vs algorithm vs software-defined scope) when the harder framing is where the argument lives. Ed 11 forces this further: "governance" itself may now be the soft word to retire.
- Treating **single-axis or single-market framings as complete** — "the BCI sector" as a fixed cast (Ed 9-10), "jurisdiction is the variable" as the whole picture (Ed 10-11), "spatial computing" as one market (Ed 11). The pattern across beats is the same: an early, useful frame gets treated as the final one, and each new edition has been adding an axis the frame didn't have room for.
...
---
*Last updated: Edition 10 — 10 June 2026*
