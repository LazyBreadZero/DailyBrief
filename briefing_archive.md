...
## EDITION 42 — Monday, 20 July 2026

### Lead Story
**Title:** New York Bars Camera Glasses from Every State Courthouse
**Category:** Policy · Smart Glasses · XR
**Core argument:** New York's Unified Court System banned all camera- and microphone-equipped eyewear from 1,240 courthouses across 62 counties, effective today — 48 hours before Samsung reveals Galaxy Glasses at London Unpacked. The rule applies to attorneys, staff, and the public alike; those carrying smart glasses surrender them to court officers at the door. Prescription eyewear with embedded recording capability is included. The rule does not change existing law (recording in New York courts was already prohibited); it changes enforcement from behavioral regulation ("do not record") to hardware exclusion ("do not bring the device"). The system determined that it could not audit what a camera is doing in real time and removed the hardware from the building instead. The LED-disclosure debate — Samsung's dual recording LEDs vs. Meta's removal of the camera indicator on Aperol/Bellini — is made moot by this logic: no disclosure design solves the audit problem when the auditor cannot verify capture state in real time. New York's court system did not wait for the EU AI Office, GDPR enforcement, or any legislative framework; it applied institutional policy on its own timetable, faster than any of those mechanisms.
**Key companies introduced:** None new
**Key people introduced:** None new
**Key concepts introduced:** Hardware exclusion as audit-incapacity bypass — when real-time audit of a capture device is impossible, institutional actors can move from behavioral regulation ("do not record") to categorical hardware exclusion ("do not bring the device"), bypassing the disclosure-design and regulatory-framework debates simultaneously.
**Sources used:** govtech.com (8/10): govtech.com/policy/new-york-will-ban-smart-glasses-from-all-courthouses; NY State of Politics (7/10): nystateofpolitics.com/state-of-politics/new-york/politics/2026/07/16/ny-unified-court-smart-glasses-ban; NY Daily Record (7/10): nydailyrecord.com/2026/07/15/smart-glasses-banned-in-court-facilities/; Forbes (8/10): forbes.com/sites/cortneyharding/2026/07/13/new-yorks-smartglasses-ban-sets-a-dangerous-precedent/; GlassesRadar (7/10): glassesradar.app/threat-intel/new-york-bans-smart-glasses-courthouses-2026
**Follow-up threads to watch:** Whether hospital administrators, employers in regulated workplaces, or schools apply the same audit-incapacity logic independently — each on its own administrative timetable, without waiting for any legislative or regulatory framework. Samsung Galaxy Glasses will be banned from 1,240 New York courtrooms before they go on sale; whether that pattern of institutional exclusion accumulates beyond courts is the live question post-Unpacked.

### Further items
None this edition.

### New concepts in Angelo's working vocabulary
- Hardware exclusion as audit-incapacity bypass: when an institution cannot audit a device's capture state in real time, the available response is categorical exclusion of the hardware rather than behavioral regulation of the user. The EU AI Office/GDPR framework question is not resolved — it is bypassed.

### Provocation(s) posed this edition
- Map the institutional spaces in the use cases you are actually translating — healthcare settings, regulated financial premises, government facilities, schools — and identify which of them has (a) a pre-existing behavioral recording prohibition and (b) no real-time audit capacity for a sealed wearable. New York's court system is the first named actor to apply this logic institutionally, but the administrative apparatus exists in all of those environments independently. Does the accumulation of institutional categorical bans create a structural ceiling on the use cases Angelo translates — before any legislation settles the question?

### Running-thread tracker
- Samsung Galaxy Glasses Unpacked — 22 July, London. Galaxy Glasses will be banned from 1,240 New York courtrooms before they go on sale. Post-Unpacked: which institutional categories apply the same exclusion logic next?
- Android XR SDK cross-form-factor test — Unpacked Tuesday. Watch for separate developer tools or capability restrictions at the glasses tier.
- Android XR three-tier architecture — Galaxy XR (£1,699, spatial), XREAL Aura ($1,500 ceiling, display AR), Galaxy Glasses ($379–$499, audio-only). Three separate markets under one platform label.
- Meta Conversation Focus subscription — $19.99/month, live August 2026.
- Science Corp CE mark — awaited; no state change.
- XREAL a01+ ($299, Micro-OLED display, available 15 July) — track post-Unpacked positioning.
- China NMPA BCI classification guidelines — watch implementation timeline and first applications.

### Thinking Ledger update
Enriched "Who can audit?" (now Ed 42): New York's Unified Court System has moved from behavioral regulation to hardware exclusion, effective today — the first US statewide institutional enforcement action based on audit-incapacity. It did not resolve the three-candidate EU body question (Commission/AI Office/national DPA); it bypassed it. Added to "Positions the evidence now implies": institutional hardware exclusion is the audit-incapacity bypass available to any institution with an existing behavioral recording prohibition — courts, hospitals, secure financial operations, government facilities. No disclosure design (Samsung's dual-LED or Meta's LED-removal) survives categorical exclusion. Added to "Blind spots": tracking smart-glasses regulatory constraints exclusively at the legislative and EU-framework layer, without a parallel column for institutional administrative bans acting independently and faster.
...
- **When audit capacity is absent, institutional exclusion is faster than regulatory resolution.** (New, Ed 42.) New York's Unified Court System moved from behavioral regulation to hardware exclusion — banning camera glasses from 1,240 courtrooms effective today, without waiting for the EU AI Office, GDPR enforcement, or any legislative framework. Both Samsung's disclosure design and Meta's LED-removal design are moot in those rooms. The same audit-incapacity logic is available to any institution with an existing recording prohibition and no real-time verification capacity: hospitals, secure financial premises, government facilities, schools. Each can act on its own administrative timetable, institution by institution, without requiring any regulatory resolution.
...
- **New (Ed 42):** Tracking smart-glasses regulatory constraints exclusively at the legislative and EU-framework layer, without maintaining a parallel column for institutional administrative bans that apply the same audit-incapacity logic independently — faster, institution by institution, without requiring any regulatory resolution.
...
| 42 | 20 Jul 2026 | New York bans camera glasses from all 1,240 state courts — first US statewide institutional ban, 48 hours before Samsung Unpacked | NY court ban; Samsung Unpacked 22 July; LED-disclosure debate bypassed by categorical hardware exclusion | None new | Which institutional spaces in the use cases you translate could adopt categorical hardware exclusion — and does that accumulation set a commercial ceiling before legislation does? |

---
*Last updated: Edition 42 — 20 July 2026*
