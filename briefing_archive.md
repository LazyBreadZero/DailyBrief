...
## EDITION 37 — Sunday, 12 July 2026

### Lead Story
**Title:** Meta Pushed a Firmware Update Killing Modified Ray-Ban Cameras. The FT Reports a Prototype That Does What Those Modifications Did.
**Category:** Platforms & Policy
**Core argument:** On 7 July, Meta pushed an OTA update that disabled cameras on Ray-Ban Meta units physically modified to defeat the privacy LED — the first known instance of a smart-glasses manufacturer using firmware to enforce a hardware privacy feature. On 9 July, the FT reported (corroborated by Fortune on 11 July) that Meta has an internal prototype called "super sensing," a glasses-form-factor device that captures continuously with no LED activation during capture by design, not by user modification.
**Key companies introduced:** Even Realities (unicorn, camera-free smart glasses, Beijing)
**Key people introduced:** Will Wang (Even Realities founder and CEO, ex-Apple Watch and iPhone hardware engineering)
**Key concepts introduced:** OTA enforcement of hardware privacy modifications; device-layer privacy (camera omission as the privacy mechanism, distinct from software policy or LED indicator); "super sensing" as the reported internal Meta prototype name for always-on capture without LED engagement
**Sources used:** 9to5Google (8/10): OTA update; Fortune (9/10): https://fortune.com/2026/07/11/meta-super-sensing-glasses-prototype/ — "super sensing" corroboration; CNBC (9/10): https://www.cnbc.com/2026/07/06/even-realities-raises-150-million-at-1-billion-valuation.html; MacRumors / The Elec (7/10): https://www.macrumors.com/2026/07/08/samsung-display-cancels-g-vr-project/
**Follow-up threads to watch:** Meta public response to the FT "super sensing" report; whether the EU AI Office, FTC, or state AG issues any inquiry; first regulatory body to name an audit mechanism for a device with no activation event

### Further items
**Samsung Display ends G-VR (Platforms & Product, July 8):** Samsung Display terminated its G-VR micro-OLED panel project (formal close September 2026), closing the Samsung Display route to a cheaper Apple Vision Pro. Source: The Elec via MacRumors (7/10). Follow-up: alternative lower-cost panel announcement; Sony roadmap for Apple Vision Pro.
**Even Realities $150M / $1B unicorn (Capital, July 6):** Camera-free AI glasses company (Beijing) raised $150m at $1bn valuation; Tencent and Meituan backed; Will Wang (ex-Apple Watch, iPhone hardware). AR display + audio, no camera. Source: CNBC (9/10). Follow-up: US/EU launch announcement; whether any regulator cites Even Realities as a privacy-compliant contrast to Ray-Ban Meta.

### New concepts in Angelo's working vocabulary
- **OTA enforcement of hardware privacy modifications** — Meta's July 7 firmware update demonstrates that a smart-glasses manufacturer can detect physical alterations to privacy features (LED defeat) and disable the affected capability via OTA update; first confirmed instance in the category
- **Device-layer privacy** — privacy achieved by omitting the camera from the hardware entirely (Even Realities model), distinct from software policy, consent flows, or LED indicator; unicorn valuation confirms commercial interest in this approach at scale

### Provocation(s) posed this edition
- Meta's firmware kill targets a hardware modification; the "super sensing" prototype designs out the disclosure mechanism as the original architecture. Three enforcement bodies are named candidates. Which of them, under what existing legal authority, can audit a capture device that has no activation event to inspect?

### Running-thread tracker
- **Meta Ray-Ban camera-kill + "super sensing" (new, Ed 37):** OTA update 7 July bricks modified cameras; FT 9 July / Fortune 11 July report "super sensing" prototype with LED absent during capture; watch for Meta public response, any regulatory inquiry
- **Even Realities $1B (new, Ed 37):** $150M / $1B; Tencent/Meituan; Will Wang; camera-free; watch for US/EU launch, specs, regulatory citations
- **Samsung Display G-VR cancelled (new, Ed 37):** formal termination September 2026; no Samsung Display path to cheaper Vision Pro micro-OLED; watch for alternative panel announcement
- Science Corp CE mark — still pending, 37 editions outstanding; no update
- OpenAI device — confirmed February 2027; middleware cross-platform in public beta; no update
- Android XR Catalyst Programme — notifications due 15 July; no update this edition
- Snap Specs — ~$2,195; no update since Ed 18
- XREAL AURA — fall 2026 Wave 1; Europe Wave 2 undated; no update
- Synchron pivotal trial — enrollment under way; no official press release; no update
- Samsung Galaxy Glasses / Unpacked — 22 July London; Snapdragon AR1 confirmed; $379–$499 estimate; no update
- Samsung Galaxy XR — UK launched Ed 36 at £1,699; Germany/France still undated; no update
- BCI implant census (~150 people, Vansteensel) — no update
- Neuracle STAR Market IPO — no update since filing
- EU AI Act Digital Omnibus — Council adopted 29 June; no update
- Connecticut neural-data privacy law — in effect 1 July 2026; no enforcement action; no update
...
### Thinking Ledger update
- **OTA enforcement capacity and "super sensing" prototype reveal two distinct privacy surfaces in the same company (new, Ed 37):** Meta's July 7 firmware demonstrates enforcement at the modification layer — the company can detect and disable hardware alterations to privacy features via OTA update. The "super sensing" prototype, as reported by the FT and Fortune, designs the activation event out of the capture architecture entirely: not a modification removed by a user but a design intent with no LED during continuous capture. The "who can audit" question from Ed 14/16/28 assumed one audit surface (the activation event). There are now two: the modification layer, where OTA enforcement already exists, and the design-intent layer, where no enforcement infrastructure exists in any of the three named jurisdictions. Ed 28's "three candidate bodies" framing — EU AI Office, state AG, FDA — needs to be applied twice, once per surface.
...
- **"Who can audit?" — is this the axis "consent" has been standing in for?** (Ed 14, enriched Ed 16, enriched Ed 28, enriched Ed 37) The three-tier smart-glasses taxonomy maps directly onto the audit-capacity question: Tier 1 (AI camera eyewear, most inconspicuous, highest bystander consent-risk) versus Tier 3 (Specs, most visible, audience self-selects). The UC Davis ALS study adds a BCI-specific dimension: the user cannot audit the accuracy of the neural decoder the way a sighted user can audit a camera's output. Himel's tier-conceding quote (Ed 23) is the first instance of an industry actor using the same taxonomy publicly, against himself. Ed 28 adds: Connecticut's no-threshold neural-data law creates an immediate audit obligation with no technical apparatus behind it; the EU Omnibus defers the compliance clock without narrowing Annex III; the FDA has device jurisdiction but not data-protection authority. There are now three named candidate bodies for the first neural-data enforcement action — EU AI Office, state AG, FDA — and none has operational audit infrastructure. The question is now: which builds it first? Ed 37 adds a second audit surface: Meta's OTA update demonstrates enforcement capacity at the modification layer (hardware alterations to the LED defeated by users; detected and disabled via firmware). The "super sensing" prototype designs the activation event out of the capture architecture — not a modification but the original design intent, with no LED during continuous capture. The three candidate bodies' existing postures assume a modification surface. The design-intent surface has no current audit framework in any of the three jurisdictions. Which builds it first, and for which surface?
...
- **Privacy enforcement in AI camera eyewear runs on two distinct surfaces, each with different audit infrastructure.** (New, Ed 37.) Meta's July 7 OTA update demonstrates enforcement capacity at the modification surface — the company can detect hardware alterations to the privacy LED and disable camera function via firmware. The "super sensing" prototype, as reported by the FT and Fortune, operates at the design-intent surface: always-on capture with no LED activation, not because a user removed it but because it was never part of the capture architecture. Existing enforcement postures from the EU AI Office, FTC, and state AGs were built against the modification surface. The design-intent surface has no current audit framework in any of the three named jurisdictions, and the distinction between "hardware mod that defeats the LED" and "device that never had the LED in the loop" is not one that existing statutes are written to address.
...
| 37 | 12 Jul 2026 | Meta Ray-Ban: OTA kills modified cameras; FT/Fortune report "super sensing" prototype (always-on capture, no LED) | Samsung Display cancels G-VR micro-OLED project; Even Realities $150M/$1B unicorn (camera-free, Tencent/Meituan) | Even Realities, Will Wang | Under what existing legal authority, in which of the three named jurisdictions, can a regulator audit a capture device designed with no activation event? |

---
*Last updated: Edition 37 — 12 July 2026*
