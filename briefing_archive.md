...
- **Is "governance" still the right word?** (Ed 11, replaces "consent or governance?") Ed 11 showed empirically that "consent" wins disputes because it has a claimant (lawsuits, press, researchers) and "governance" loses because it doesn't — Meta deleted Stella's code (a consent fix) and left every governance question (does NameTag return, what happened to prior data) unanswered, unchallenged. If "governance" commits no one to anything, is it the word Angelo should keep reaching for, or should he name the actual missing thing — a body with standing to review dormant capability pre-launch? No new evidence Ed 13.
- **Is BCI's commercial structure resolved into one axis, or does it run on several?** (Ed 10-13, consolidated) Hardware/regulatory (jurisdiction-driven), algorithmic (academic-timeline, Ed 10), software-defined scope (Ed 11 Neuralink "any brain region"), signal resolution (Ed 12, 1,000→3,000 electrodes) — and now, per Ed 13, the architecture-spectrum axis (conservative vs. maximal) may interact with the regulatory-race axis: NEO's conservative 8-electrode design reached approval and reimbursement in the time Neuralink has spent expanding scope and channel count. Has Angelo's map of "what determines BCI's commercial future" kept pace with five interacting axes, or is he still defending a simpler frame?
- **Is "spatial computing" one market or several?** (Ed 11-13) Snap's $2,500 Specs vs. Android XR's sub-$500 audio glasses (Ed 11); Ed 12's Seoul showroom made the comparison global; Ed 13 adds Acer's $499 binocular-display GR0 (a possible counter-example to the two-band price/capability mapping) and Snap's Illumix acquisition (a software-layer move independent of price). Has Angelo picked which market — or markets — he's translating for, or is the picture still widening?
- **"First to approval" vs. "biggest platform" — does Angelo conflate two different races?** (new, Ed 13) NEO won regulatory approval first with 8 electrodes and one narrow indication; Neuralink is building toward 3,000 electrodes and "any brain region." When Angelo says "the BCI commercial race," which of these is he describing — and has he been letting one's "first" and the other's "biggest" stand in for each other?
- **When "true" and "tells well in one sentence" conflict, which does Angelo optimize for?** (new, Ed 13, from the Edition 3 correction) Edition 3 fused two true stories into one false, cleaner one — and the fused version was more useful to repeat. This is a question about Angelo's own habits of narrative selection, not just this briefing's sourcing.
- **Are AWE's institutional layers (Hall of Fame vs. Startup to Watch) one verdict or several disagreeing ones?** (Ed 12-13, reframed) Ed 12 found no neurotech in the Hall of Fame; Ed 13 found two neuro-named companies in Startup to Watch. Rather than resolving which is "real," this may be evidence that no institution gives one verdict — a pattern relevant to every institution Angelo reads for signal. AWE opens Monday.

### Positions the evidence now implies (and whether his view has moved)
- **Edition 3's "world's first" claim was not just unverified — it was wrong, and wrong via narrative fusion.** Two true, separately-sourced Chinese BCI stories (NEO's NMPA approval; NeuroXess's research benchmark) were combined into one false, cleaner story. Four credible sources did not catch this, because the failure mode was narrative selection, not sourcing. This is a sharper, more uncomfortable finding than Ed 12's "unresolved duplicate claim" — it closes that question but opens one about Angelo's own selection habits (Provocation 1).
- **The architecture spectrum (Ed 1) may now predict regulatory speed, not just invasiveness.** NEO's conservative 8-electrode, narrow-indication design reached NMPA approval and a reimbursement code within a week of each other. Neuralink's maximal trajectory (3,000 electrodes, any brain region, broad indications) has, on current evidence, a longer road. Whether "conservative wins the regulatory race, maximal wins the eventual market" is the right read — or whether these are simply incommensurable — is Ed 13's Deep Read, deliberately left open.
- **"Consent" beats "governance" not on the merits but on enforcement.** (Carried from Ed 11, no new evidence Ed 13.) Disclosure violations get fixed because someone can sue or report on them; "should this capability exist at all" questions get silence because no one can compel more.
- **AR/XR's bifurcation keeps acquiring new entrants without resolving.** Snap's $2,500 vs. Android XR's sub-$500 (Ed 11); Seoul's three-ecosystem showroom (Ed 12); now Acer's $499 binocular-display GR0 and Snap's Illumix acquisition (Ed 13). Each edition adds a player or a dimension; none has yet collapsed the picture back to fewer than three threads.
- **The convergence thesis runs ahead of the institutions that would ratify it — but "the institution" may not be a single thing.** Ed 12: AWE's Hall of Fame contains no neurotech. Ed 13: AWE's Startup to Watch list contains two neuro-named companies. If different layers of the same institution give different answers, "is the convergence institutionally real" may be the wrong shape of question.

### Blind spots he keeps circling
- Reaching for the **softer or more familiar word, or the cleaner narrative**, when the harder or messier framing is where the argument lives. Ed 13 generalizes this from Edition 3's specific error: the fused "NeuroXess, world's first" story wasn't just imprecise — it was the version that traveled best.
- Treating **single-axis, single-market, or single-verdict framings as complete** — across BCI's commercial structure (now five interacting axes), spatial computing's markets (now three-plus threads), and institutions (now potentially multiple disagreeing layers, not one verdict). Each new edition has been adding dimensions to frames Angelo had treated as settled.
- **Carried (Ed 12):** Citing "world's first" claims, especially from opaque regulatory environments (NMPA), without flagging that the claim itself may not be unique or verifiable — now confirmed as a real, not hypothetical, gap in this briefing's (and potentially Angelo's) past citations.
